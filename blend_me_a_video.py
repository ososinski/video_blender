...
scale.transform.offset_x = resx/4+15 #(half+30)/2
scale.transform.offset_y = -((resy/4)-25)
...
for row in meta_data:
    ...
    sseq.transform.offset_y = 440 # should be resy*0.567 (440/776) -> above the images, but we use fixed width/height either way
