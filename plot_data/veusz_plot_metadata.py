...
graph1 = page.Add("graph", autoadd=False, Background__transparency=100)

graph2 = page.Add("graph", autoadd=False, Background__transparency=100)
...
x_axis1 = graph1.Add("axis")
y_axis1 = graph1.Add("axis")

x_axis1.min.val = "auto"
x_axis1.max.val = "auto"

y_axis1.min.val = "auto"
y_axis1.max.val = "auto"

plot1 = graph1.Add('xy', marker='circle',markerSize='0',PlotLine__color='blue', PlotLine__width = "0.03825in", MarkerFill__color='green', PlotLine__bezierJoin=True)

graph1.leftMargin.val = "0cm"
graph1.rightMargin.val = "0cm"
graph1.topMargin.val = "0cm"
graph1.bottomMargin.val = "0cm"

plot1.xData.val = "timestamp"#"image_number"
plot1.yData.val = "%s(1)"%(args.label)


x_axis1.MinorTicks.hide.val = True
x_axis1.MajorTicks.hide.val = True
#x_axis1.autoMirror.val = False #mirror line on the other side
x_axis1.Line.hide.val = True
x_axis1.autoRange.val = "exact"
x_axis1.mode.val = "labels"
#x_axis1.datascale.val = 1

y_axis1.MinorTicks.hide.val = True
y_axis1.MajorTicks.hide.val = True
#y_axis1.autoMirror.val = False #mirror line on the other side
y_axis1.Line.hide.val = True
y_axis1.autoRange.val = "+5%"
y_axis1.mode.val = "labels"

graph1.Border.hide.val = True

### graph2

x_axis2 = graph2.Add("axis")
y_axis2 = graph2.Add("axis")

x_axis2.min.val = "auto"
x_axis2.max.val = "auto"

y_axis2.min.val = "auto"
y_axis2.max.val = "auto"

plot2 = graph2.Add('xy', marker='circle',markerSize='0',PlotLine__color='green', PlotLine__width = "0.03825in", MarkerFill__color='green',  PlotLine__bezierJoin=True)

graph2.leftMargin.val = "0cm"
graph2.rightMargin.val = "0cm"
graph2.topMargin.val = "0cm"
graph2.bottomMargin.val = "0cm"

plot2.xData.val = "timestamp"#"image_number"
plot2.yData.val = "%s(2)"%(args.label)

x_axis2.MinorTicks.hide.val = True
x_axis2.MajorTicks.hide.val = True
#x_axis2.autoMirror.val = False #mirror line on the other side
x_axis2.Line.hide.val = True
x_axis2.autoRange.val = "exact"
x_axis2.mode.val = "labels"
#x_axis2.datascale.val = 1

y_axis2.MinorTicks.hide.val = True
y_axis2.MajorTicks.hide.val = True
#y_axis2.autoMirror.val = False #mirror line on the other side
y_axis2.Line.hide.val = True
y_axis2.autoRange.val = "+5%"
y_axis2.mode.val = "labels"

graph2.Border.hide.val = True

# nd of if(mean||variance)
